#!/usr/bin/env python
'''
Mocking Httpclient and AsyncHttpclient in Tornado
'''
...
class TestHandler(tornado.web.RequestHandler):
    ...
    def get(self, *args, **kwargs):
        ...
        #print http_client.fetch(req,cb)
        resp = yield tornado.gen.Task(http_client.fetch,req)
...
class TestBrightcoveServices(AsyncHTTPTestCase):
    ...
    def test_asynchttpclient(self):
        ...
        self.mock_async_client().fetch.side_effect = lambda x,callback: callback(response) #use async http mock
