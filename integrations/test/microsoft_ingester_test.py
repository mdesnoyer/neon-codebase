...
class SmokeTesting(test_utils.neontest.AsyncTestCase):
    def setUp(self):
        ...
        self.int_mocker = patch(
            'integrations.ingester.integrations.microsoft.'
        ...
        self.integration = neondata.MicrosoftIntegration(self.user.neon_api_key,  
                                                   ...
                                                   feed_id='c2vfn5fb8gubhrmd67x7bmv9')
        ...
        options._set('integrations.ingester.service_name', 'microsoft')
    ...
    def test_two_platforms(self):
        integration_two = neondata.MicrosoftIntegration('acct2',  
                                                  last_process_date='2015-10-29T23:59:59Z', 
                                                  feed_id='c2vfn5fb8gubhrmd67x7bmv9')
    ...
    def test_platform_disabled(self):
        def _set_platform(x):
            x.enabled = False
        neondata.MicrosoftIntegration.modify(self.integration.integration_id, _set_platform)
