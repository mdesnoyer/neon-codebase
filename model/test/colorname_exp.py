...
class ColorNameExtension(ColorName):
    ...
    def image_to_colorname_color(self):
        colorname_image = _image_to_colorname()
        self.new_color_image = (COLOR_VALUES[colorname_image]*255)
...
def main():
    ...
    print (gist_error, gist_cut_off)
    print (colorname_error, colorname_cut_off)
