...
class NeonUserAccount(NamespacedStoredObject):
    ...
    def __init__(self, 
                 ...
                 verify_subscription_expiry=None):
        ...
        # local copy of the subscription state, can be 'active', 'canceled',
        # 'future', 'expired' - defined in SubscriptionState
	self.subscription_state = subscription_state 
        ...
        self.verify_subscription_expiry = verify_subscription_expiry or \
