...
class OptimizelyController(ControllerBase):
    ...
    @tornado.gen.coroutine
    def verify_experiment(self, platform_id, experiment_id, video_id, extras={}):
        ...
        ecmd = yield tornado.gen.Task(
            ExperimentControllerMetaData.get, self.api_key, video_id)
        ...
        if ecmd:
            ...
            ecmd = ExperimentControllerMetaData(
    ...
    def send_request(self, relative_path, method='GET', body=None):
        ...
        response = yield self.do_http_request(
            client_url, method, headers, req_body)
...
class ExperimentControllerMetaData(NamespacedStoredObject):
    def __init__(self, api_key, platform_id='', c_type='',
        ...
        state = ControllerExperimentState.PENDING
        self.controllers = [{
