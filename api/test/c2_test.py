...
class TestVideoClient2(unittest.TestCase):
    ''' 
    ...
    def setup_video_processor(self, rtype):
        ...
        vprocessor = api.c2.VideoProcessor(job, self.model, self.model_version)
        return vprocessor 

    def tearDown(self):
        self.redis.stop()

    @patch('api.c2.S3Connection')
    def test_save_thumbnail_to_s3_and_metadata(self, mock_conntype):
        ...
        keyname = "test_key"
        i_vid = "i_vid1"
        tdata = api.c2.save_thumbnail_to_s3_and_metadata(
    ...
    def test_host_images_s3(self, mock_conntype):
        ...
        thumbnails, s3_urls = api.c2.host_images_s3(
                                    api_key, vid, 
                                    images, bfname)
    ...
    def test_callback_response_builder(self):
        pass
    ...
    ##### Process video tests ####
    @patch('api.c2.tornado.httpclient.HTTPClient')
    ...
    @patch('api.c2.VideoProcessor.finalize_api_request')
    @patch('api.c2.VideoProcessor.http_request_pool')
    @patch('api.c2.S3Connection')
