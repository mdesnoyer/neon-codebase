...
def notification_response_builder(i_id, video_json, event="processing_complete"):
        '''
...
class VideoProcessor(object):
    ...
    def start():
        ...
        if self.finalize_request():
            self.send_client_callback_response()
...
class VideoClient(object):
    ...
    def dequeue_job(self):
        ...
        try:
            ...
            self.http_pool.send_request(req)
    ...
    def do_work(self):   
        ...
        try:
            ...
            vprocessor = VideoProcessor(job, self.model, self.model_version)
            vprocessor.start()
