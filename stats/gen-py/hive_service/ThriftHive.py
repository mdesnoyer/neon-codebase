...
class getThriftSchema_args(object):
...
class getThriftSchema_result(object):
  """
  Attributes:
   - success
   - ex
...
class getQueryPlan_args(object):
...
class getQueryPlan_result(object):
  """
  Attributes:
   - success
   - ex
