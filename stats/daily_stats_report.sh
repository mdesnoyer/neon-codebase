...
COMMON_PARAMS="--start_time ${YESTERDAY} --end_time ${TODAY} --cmsdb.neondata.wants_postgres 1 --cmsdb.neondata.db_user readonly_user --cmsdb.neondata.db_password e73zfjiRO3Mr --cmsdb.neondata.db_address postgres-prod.cnvazyzlgq2v.us-east-1.rds.amazonaws.com"
