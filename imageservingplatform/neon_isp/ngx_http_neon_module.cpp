...
static ngx_int_t ngx_http_neon_handler_stats(ngx_http_request_t *r)
{
    ...
    "MASTERMIND_PARSE_PARTIAL", neon_stats[MASTERMIND_PARSE_PARTIAL],
    "MASTERMIND_PARSE_FAIL", neon_stats[MASTERMIND_PARSE_FAIL],
    "MASTERMIND_ENTRY_REJECTED", neon_stats[MASTERMIND_ENTRY_REJECTED], 
    "MASTERMIND_RENAME_SUCCESS", neon_stats[MASTERMIND_RENAME_SUCCESS],
    "MASTERMIND_RENAME_FAIL", neon_stats[MASTERMIND_RENAME_FAIL],
    "NEON_DEFAULT_IMAGE", neon_stats[NEON_DEFAULT_IMAGE],
    "NEON_DEFAULT_IMAGE_PERFECT_FIT", neon_stats[NEON_DEFAULT_IMAGE_PERFECT_FIT],
    "NEON_DEFAULT_IMAGE_APPROX_FIT", neon_stats[NEON_DEFAULT_IMAGE_APPROX_FIT],
    ...
    "NEON_VIDEO_API_REQUESTS", neon_stats[NEON_VIDEO_API_REQUESTS],
    ...
    "NEON_DEFAULT_THUMBNAIL_PARSE_ERROR", neon_stats[NEON_DEFAULT_THUMBNAIL_PARSE_ERROR],
    "NEON_DEFAULT_THUMBNAIL_INVALID", neon_stats[NEON_DEFAULT_THUMBNAIL_INVALID],
    "NEON_DEFAULT_THUMBNAIL_HASTABLE_INVALID_INIT", neon_stats[NEON_DEFAULT_THUMBNAIL_HASTABLE_INVALID_INIT],
    "NEON_DEFAULT_THUMBNAIL_HASTABLE_INVALID_SHUTDOWN", neon_stats[NEON_DEFAULT_THUMBNAIL_HASTABLE_INVALID_SHUTDOWN],
    "NEON_DEFAULT_THUMBNAIL_SHUTDOWN_NULL_POINTER", neon_stats[NEON_DEFAULT_THUMBNAIL_SHUTDOWN_NULL_POINTER],
